...
public class VAddActivity extends Activity implements OnClickListener{
	...
	private void setViewDate(Context mContext,final EditText btn){
		...
		date = nYear + "-" + mtConfiger.get2bitData((nMonth + 1)) + "-" + mtConfiger.get2bitData(nDay)+" ";
		time = mtConfiger.get2bitData(nHour) + ":" + mtConfiger.get2bitData(nMinute);
		datePicker.init(nYear, nMonth, nDay, new OnDateChangedListener() {
			...
			public void onDateChanged(DatePicker view, int year,
				...
				// 日历控件;
				date = year + "-" + mtConfiger.get2bitData((monthOfYear + 1)) + "-" + mtConfiger.get2bitData(dayOfMonth) + " ";
			}
		});
