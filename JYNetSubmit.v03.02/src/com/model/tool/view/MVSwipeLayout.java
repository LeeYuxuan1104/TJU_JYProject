 ...
 */
@SuppressLint("NewApi")
public class MVSwipeLayout extends LinearLayout {
	// 分析手势处理的类
	...
	public MVSwipeLayout(Context context) {
		this(context, null);
	}

	public MVSwipeLayout(Context context, AttributeSet attrs) {
		this(context, attrs, -1);
	}

	public MVSwipeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private class DragHelperCallback extends ViewDragHelper.Callback {
		...
		public void onViewReleased(View releasedChild, float xvel, float yvel) {
			...
			ViewCompat.postInvalidateOnAnimation(MVSwipeLayout.this);
		}
	}
