...
public class MVCalendar extends ViewFlipper implements
	...
	private String[] weekday = new String[] { "Sun", "Mon", "Tue", "Wed", "Thur", "Fri", "Sat" }; // 星期标题
	...
	public MVCalendar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public MVCalendar(Context context) {
		super(context);
		init();
	}
