...
public class HarborHistoryActivity extends Activity implements OnClickListener{
    //  信息内容的全局变量;
    ...
    private void initEvent(){
        mContext        =   HarborHistoryActivity.this;
        //  数据库信息的加载;
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapter, View view, int position,
                                    long id) {
                Intent  intent  =new Intent(HarborHistoryActivity.this, HarborDetail2Activity.class);
        ...
        switch (nVid) {
            case R.id.btnFunction:
                ...
                for(String bid:mListBid){
                    String folder=mConfigHelper.getfParentPath()+bid+File.separator+"harbor";
