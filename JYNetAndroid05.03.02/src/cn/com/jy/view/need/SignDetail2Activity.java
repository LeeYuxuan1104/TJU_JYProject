...
public class SignDetail2Activity extends Activity implements OnClickListener{
	//	全程序内容;
	...
	private void initEvent(){
		mContext		=	SignDetail2Activity.this;
	...
	private void doLoadData(int size){
		...
		while (mCursor.moveToNext()) {	
			...
			listInfo.add("签收时间    "+receiptdate);
			listInfo.add("商品状态    "+cargostatussign);
