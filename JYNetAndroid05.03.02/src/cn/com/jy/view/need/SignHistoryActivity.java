...
public class SignHistoryActivity extends Activity implements OnClickListener{
	//	信息内容的全局变量;
	...
	private String 			sql;
	//	按钮;
	private TextView		vBack,vFunction,vTopic;
	@Override
	...
	private void initEvent(){
		mContext		=	SignHistoryActivity.this;
		//	数据库信息的加载;
		...
		//	初始化信息内容;
		vTopic.setText("签收历史信息");
		vFunction.setText("清空");
		//	添加事件监听;
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapter, View view, int position,
					long id) {
				Intent  intent	=new Intent(SignHistoryActivity.this, SignDetail2Activity.class);
