...
public class VAddActivity extends Activity implements OnClickListener{
	...
	private void showImageSet(Context context){
		...
		gridView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				//	设置boolean类型;
				boolean flag=imageAdpter.chiceState(position);
				//	设置列表中的状态项;
	...
	private void showImage(Context mContext,String imagePath){
		...
		View  		view   = getLayoutInflater().inflate(R.layout.img_show, null);
        ...
        iv.setBackgroundDrawable(new BitmapDrawable(this.getResources(),newbm));
